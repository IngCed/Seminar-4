...
public class Sale {
     ...
     * @param revenueObservers the list to be added.
     */
    public void addRevenueObservers(List<RevenueObserver> revenueObservers) {
        revenueObservers.addAll(revenueObservers);
    }
